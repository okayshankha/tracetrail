...
export default function RequestList() {
  ...
  const FetchData = useCallback(
        ...
        params: _.omitBy(
          {
            startIndex,
            method:
              requestLogs.dropdowns.methodFilter.value !== 'ALL'
                ? requestLogs.dropdowns.methodFilter.value
                : null,
            statusCode:
              requestLogs.dropdowns.statusCodeFilter.value !== 'ALL'
    ...
    [
      dispatch,
      requestLogs.endpoint,
      requestLogs.dropdowns,
      requestLogs.baseURL,
    ],
  )
    ...
    <div className="card">
      <div className="card-body">
        <div className="d-flex flex-row justify-content-between">
          ...
          <div className="float-right mt-1">
            ...
            <button
              ...
              disabled={
                requestLogs.totalItems <
                requestLogs.startIndex + requestLogs.itemsPerPage
              }
            >
        ...
        <p className="display-4 m-0" style={{ fontSize: '11px' }}>
          Showing {requestLogs.totalItems ? requestLogs.startIndex : 0} -{' '}
          {Math.min(
            requestLogs.totalItems,
            requestLogs.startIndex + requestLogs.itemsPerPage - 1,
          )}{' '}
          of {requestLogs.totalItems} records
        </p>
          ...
          <div className="col-12">
            <div className="row">
              <MethodFilterDropdown
                dropdownValues={MethodFilterDropdownValues}
              ></MethodFilterDropdown>
